	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(ev)
				...
				keymap.set("n", "<leder>gd", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
				...
				keymap.set("n", "<leader>gb", vim.diagnostic.open_float, opts) -- show diagnostics for line
